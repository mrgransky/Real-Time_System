...
public class VisionProcessing extends Thread { 
	...
	private double hAngle =.05; // 50 [ms] approx. vision processing update time
...
H.ones(new Size(hsv_image.width(),hsv_image.height()),CvType.CV_8UC1);*/  
		...
		Scalar hsv_min_red = new Scalar(0, 112, 2, 0);  
		Scalar hsv_max_red = new Scalar(8, 169, 255, 0);  
		...
		Scalar hsv_min_blue = new Scalar(0, 52, 178, 0); 
		Scalar hsv_max_blue = new Scalar(41, 165, 254, 0); 
...
//					System.out.println("theta" + theta);
				...
				// For the filter	
					...
					smoothedAngleDer = (smoothedAngle - smoothedAngleOld)/hAngle;
